  ...
  module Client
    ...
    module IOAdapter
      def decode(io)
        ...
        raise InconsistentDataError.new unless frame_end == FINAL_OCTET # TODO: this will hang if the size is bigger than expected or it'll leave there some chars -> make it more error-proof
